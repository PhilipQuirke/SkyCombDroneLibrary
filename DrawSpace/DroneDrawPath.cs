    ...
    public class DroneDrawPath : DroneDrawGraph
    {
        ...
        public void Initialise(Size size, DroneLocation? processObjectLocation, GroundType groundType)
        {
            try
            {
                ...
                var tightFocusM = 10f; // This is enough to see location of object, but sometimes not the flight path if it is at the very edge of view.
                ...
                else
                {
                    ...
                    DroneLocation? scopeMinLocnM = DroneDrawScope.TardisSummary.MinDroneLocnM;
                    DroneLocation? scopeMaxLocnM = DroneDrawScope.TardisSummary.MaxDroneLocnM;
                    DroneLocation? minLocation = (scopeMinLocnM == null ? null : scopeMinLocnM.Clone());
                    DroneLocation? maxLocation = (scopeMaxLocnM == null ? null : scopeMaxLocnM.Clone());
                    if (tightFocus)
                    {
